...
if __name__ == "__main__":
    arquivo_json = base_dir / f"dados_contratacoes - {hoje_string_arq}.json"  # nome do arquivo de entrada
    arquivo_saida = base_dir / f"fichas_propostas - {hoje_string_arq}.txt"  # nome do arquivo de saída
